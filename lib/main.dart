...
import 'package:payment_app/custom_ui.dart';
import 'package:payment_app/ready_ui.dart';

main() => runApp(true?MyApp():OutsideCheckout());
...
class OutsideCheckout extends StatelessWidget {
  const OutsideCheckout({Key? key}) : super(key: key);
